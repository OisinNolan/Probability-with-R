...
RANDUavgPvalue <- RunRunsTest(randu, 100, 31)

SMavgPvalue <- RunRunsTest(StandardMinimal, 100, 31)

MTavgPvalue <- RunRunsTest(MersenneTwister, 100, 32)

VNavgPvalue <- RunRunsTest(VonNeumann, 100, 14)
```
