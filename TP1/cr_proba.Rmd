...
RANDUavgPvalue <- RunFrequencyTest(randu, 100, 31)

SMavgPvalue <- RunFrequencyTest(StandardMinimal, 100, 31)

MTavgPvalue <- RunFrequencyTest(MersenneTwister, 100, 32)

VNavgPvalue <- RunFrequencyTest(VonNeumann, 100, 14)
...
Algorithm                | Avg. P value             | Pass Rate
------------------------ | ------------------------ | ------------------------
...
RANDUavgPvalue <- RunOrderTest(randu, 100)

SMavgPvalue <- RunOrderTest(StandardMinimal, 100)

MTavgPvalue <- RunOrderTest(MersenneTwister, 100)

VNavgPvalue <- RunOrderTest(VonNeumann, 100)
```
...
par(mfrow=c(2,2))
plot(evo8$T, evo8$N , type='s')
plot(evo14$T, evo14$N , type='s')
plot(evo15$T, evo15$N , type='s')
plot(evo20$T, evo20$N , type='s')
```
